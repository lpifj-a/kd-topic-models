...
def train(
    ...
    mb_gen = create_minibatch(X, Y, PC, TC, DR, TE_list, teacher_emb=teacher_emb, batch_size=batch_size, rng=rng)
...
def create_minibatch(X, Y, PC, TC, DR, TE_list, teacher_emb=None, batch_size=200, rng=None):
